...
public static void main(String[] args) {
    ...
    //Double total is moved into the same bracket as 'total' string for total string to recognize where the value comes from
    //string must be added before the loop to recognize string. Thus, the int value is added first, but the scan is added afterwards.
    //selection assigned 0 as default to still be lower than 4.
    while (selection !=4) {
